/*
            ...
            FRANKIE YOU NEED TO COME BACK TO THIS FILE
            thy this was left incomplete and where to pick up from
            their are a lot of methods...
            realized constructor is used within the "class" and
            needs to be reread
...
class Contract extends Core {
    constructor (jsonInterface, address, options) {
        ...
        Object.defineProperty(this.options, 'address', {
            set: function(value){
                if(value) {
                    this._address = utils.toChecksumAddress(formatters.inputAddressFormatter(value));
                }
            },
            get: function(){
                ...
                this._jsonInterface = value.map(function(method) {
                    ...
                    if (method.type === 'function') {
                        ...
                        if(!this.methods[method.name]) {
                            ...
                            var cascadeFunc = this._createTxObject.bind({
                                method: method,
                                parent: this,
                    ...
                    // event
                        ...
                        var event = this._on.bind(this, method.signature);

                        // add method only if not already exists
                        if(!this.events[method.name] || this.events[method.name].name === 'bound ')
        ...
        Object.defineProperty(this, 'handleRevert', {
            get: function () {
                if (this.options.handleRevert === false || this.options.handleRevert === true) {
        ...
        Object.defineProperty(this, 'defaultHardfork', {
            get: function () {
                return this.options.hardfork || this.constructor.defaultHardfork;
            },
            set: function (val) {
        ...
        Object.defineProperty(this, 'transactionPollingTimeout', {
            get: function () {
                ...
                return this.options.transactionPollingTimeout || this.constructor.transactionPollingTimeout;
            },
            set: function (val) {
        ...
        Object.defineProperty(this, 'transactionConfirmationBlocks', {
            get: function () {
                ...
                return this.options.transactionConfirmationBlocks || this.constructor.transactionConfirmationBlocks;
            },
            set: function (val) {
        ...
        Object.defineProperty(this, 'transactionBlockTimeout', {
            get: function () {
                ...
                return this.options.transactionBlockTimeout || this.constructor.transactionBlockTimeout;
            },
            set: function (val) {
     ...
     */
    _getCallback (args = []) {
        if (typeof [...args].pop() === 'function') return args.pop();
    }
     ...
     */
    _encodeEventABI = function (event, options) {
        options = options || {};
     ...
     */
    _createTxObject =  function _createTxObject(){
        var args = Array.prototype.slice.call(arguments);
        var txObject = {};
     ...
     * @param {Promise} defer
     */
    _processExecuteArguments = function _processExecuteArguments(args, defer) {
        var processedArgs = {};
    ...
    _executeMethod = function _executeMethod(){
        var this = this,
            ...
            ethAccounts = this.constructor._ethAccounts || this._ethAccounts;
            ...
            case 'call':
                ...
                var call = (new Method({
                    ...
                    outputFormatter: function (result) {
                        return this._parent._decodeMethodReturn(this._method.outputs, result);
                    },
                    requestManager: this._parent._requestManager,
                    accounts: ethAccounts, // is eth.accounts (necessary for wallet signing)
                    defaultAccount: this._parent.defaultAccount,
            ...
            case 'send':
                ...
                var extraFormatters = {
                        ...
                        if (_.isArray(receipt.logs)) {
                            ...
                            var events = _.map(receipt.logs, function(log) {
                                return this._parent._decodeEventABI.call({
                                    name: 'ALLEVENTS',
                                    jsonInterface: this._parent.options.jsonInterface
                                }, log);
                            });
                    ...
                    contractDeployFormatter: function (receipt) {
                        var newContract = this._parent.clone();
                ...
                var sendTransaction = (new Method({
                    ...
                    requestManager: this._parent._requestManager,
                    accounts: this.constructor._ethAccounts || this._ethAccounts, // is eth.accounts (necessary for wallet signing)
                    defaultAccount: this._parent.defaultAccount,
                    defaultBlock: this._parent.defaultBlock,
                    transactionBlockTimeout: this._parent.transactionBlockTimeout,
                    transactionConfirmationBlocks: this._parent.transactionConfirmationBlocks,
                    transactionPollingTimeout: this._parent.transactionPollingTimeout,
